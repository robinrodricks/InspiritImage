...
xy* fast10_detect_edge(const byte* im, const byte* edg, int xsize, int ysize, int stride, int b, int* ret_num_corners);
...
xy* fast10_detect_nonmax_edge(const byte* im, const byte *edg, int xsize, int ysize, int stride, int b, int* ret_num_corners);
